...
author: "Thomas Kinzeler & Daniel Kaplan"
date: "8/12/2020"
output:
...
Open up the [Little App Density](`r Density_app$url`)  Little App. (See footnote^[<`r Density_app$url`>]).  In the Data tab in the top tool bar, set the Source Package to Little Apps, and the Data set to NHANES2. Set the response variable to `height_adults`. 
