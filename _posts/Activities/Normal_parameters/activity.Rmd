...
Open up the [Density](`r Density_app$url`) Little App. (See footnote^[<`r Density_app$url`>]). In the Data tab in the top toll bar, set the Source Package to Little Apps, and the Data set to NHANES2. Set the response variable to `height_adults`. 
